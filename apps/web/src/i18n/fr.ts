...
export const fr: Record<keyof typeof en, string> = {
  ...
  "nav.profile": "Profil",
  "sky.night": "Nuit",
  "sky.dawn": "Lever du soleil",
  "sky.dusk": "Coucher du soleil",
  "sky.clear": "Plein soleil — {kw} kW",
  "sky.partly": "Quelques nuages — {kw} kW",
  "sky.cloudy": "Couvert — {kw} kW",
  "sky.snow": "Neige, ou un ciel aussi sombre — {kw} kW",
  ...
  "settings.liveNote": "Ce que la section « en ce moment » lit — sur le tableau de bord, où le propriétaire voit aussi le flux en direct de la maison, et sur la page Consommation des participants. Ce sont des relevés instantanés, lus uniquement pendant qu'on les regarde et jamais enregistrés — contrairement aux statistiques ci-dessus, qui deviennent l'historique.",
  ...
  "settings.live.battery": "Puissance batterie actuelle",
  "settings.live.batteryHint": "Un seul capteur signé pour la charge et la décharge — les liaisons de la batterie sur le flux en direct du tableau de bord",
  "settings.live.batteryChargeNegative": "Négatif pendant la charge",
  "settings.live.batteryChargeNegativeHint": "À cocher si le capteur passe sous zéro pendant que la batterie se charge. La puissance charge/décharge Huawei est positive en charge et négative en décharge — laisser décoché dans ce cas.",
  "settings.live.soc": "État de charge de la batterie",
  "settings.live.socHint": "Pourcentage de remplissage, affiché dans l'anneau de la batterie du flux en direct",
  "settings.live.load": "Consommation de la maison actuelle",
  "settings.live.loadHint": "Ce que la maison consomme à cet instant. Facultatif : sans lui, le flux en direct additionne ce qui arrive à la maison ; avec lui, la part de chaque flux dans la consommation s'affiche au survol",
  ...
  "account.markUnpaid": "Repasser en impayée",
  "billing.intro":
  ...
  "dash.energyFlow": "Flux d'énergie",
  "dash.energyFlowNote": "Où est allée l'énergie de la période, en kWh : ce que les panneaux ont produit (y compris ce qui a chargé la batterie) et ce qui est venu du réseau, et ce que cette énergie a alimenté — la maison, les participants ou le réseau. La batterie restitue moins qu'elle n'a reçu : pertes de conversion, plus ce qu'elle contient encore. Deux dessins des mêmes chiffres : la largeur des rubans du Sankey dit combien, la carte radiale dit où, ses points circulant dans le sens de l'énergie.",
  "flow.grid": "Réseau",
  "flow.gridImport": "Réseau (soutirage)",
  "flow.sun": "Soleil",
  "flow.battery": "Batterie",
  "flow.house": "Maison",
  "flow.gridExport": "Réseau (injection)",
  "flow.vzev": "Participants RCPv",
  "flow.share": "{node} : {pct} %",
  "flow.noData": "Aucune mesure sur cette période.",
  "flow.table": "Flux d'énergie sur la période",
