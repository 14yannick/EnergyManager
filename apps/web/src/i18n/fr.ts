...
export const fr: Record<keyof typeof en, string> = {
  ...
  "party.live.madeTodayHint": "La production propre, qu'elle ait été consommée directement ou stockée dans la batterie — plus que ce que « Disponible pour le RCPv » seul laisserait penser.",
  "party.live.leftHouse": "Disponible pour le RCPv",
  "party.live.forecastTotal": "Prévision",
  "party.live.keptAtHome": "Consommation propre",
  ...
  "party.kpi.localShareSub": "{kwh} kWh du solaire du RCPv",
  "party.kpi.cost": "Coût via le RCPv",
  "party.kpi.costSub": "Ø {rate} {cents}/kWh, tout compris",
  "party.kpi.saved": "Économie par rapport à l'approvisionnement direct",
