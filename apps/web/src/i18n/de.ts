...
export const de: Record<keyof typeof en, string> = {
  ...
  "nav.profile": "Profil",
  "sky.night": "Nacht",
  "sky.dawn": "Sonnenaufgang",
  "sky.dusk": "Sonnenuntergang",
  "sky.clear": "Volle Sonne — {kw} kW",
  "sky.partly": "Etwas bewölkt — {kw} kW",
  "sky.cloudy": "Bedeckt — {kw} kW",
  "sky.snow": "Schnee, oder ein ebenso dunkler Himmel — {kw} kW",
  ...
  "settings.liveNote": "Was der Abschnitt „Jetzt“ liest — auf dem Dashboard, wo der Eigentümer auch den Live-Fluss des Hauses sieht, und auf der Verbrauchsseite der Teilnehmer. Das sind Momentanwerte, die nur beim Betrachten gelesen und nie gespeichert werden — anders als die Statistiken oben, aus denen Historie wird.",
  ...
  "settings.live.battery": "Batterieleistung jetzt",
  "settings.live.batteryHint": "Ein vorzeichenbehafteter Sensor für Laden und Entladen — die Verbindungen der Batterie im Live-Fluss des Dashboards",
  "settings.live.batteryChargeNegative": "Negativ beim Laden",
  "settings.live.batteryChargeNegativeHint": "Ankreuzen, wenn der Sensor beim Laden unter null liegt. Huaweis Lade-/Entladeleistung ist beim Laden positiv und beim Entladen negativ — dafür nicht ankreuzen.",
  "settings.live.soc": "Ladezustand der Batterie",
  "settings.live.socHint": "Füllstand in Prozent, im Batteriering des Live-Flusses",
  "settings.live.load": "Hauslast jetzt",
  "settings.live.loadHint": "Was das Haus in diesem Moment verbraucht. Optional: ohne ihn summiert der Live-Fluss, was das Haus erreicht; mit ihm zeigt jede Verbindung beim Überfahren ihren Anteil am Hausbezug",
  ...
  "settings.driveNote": "Archiviert jede erstellte Rechnungs-PDF in einem Drive-Ordner, zusätzlich zum ZIP-Download.",
  "settings.driveUnconfigured": "Nicht konfiguriert — GOOGLE_DRIVE_SERVICE_ACCOUNT_KEY_FILE auf dem Server setzen, um dies zu aktivieren.",
  "settings.driveServiceAccount": "Diesen Ordner in Drive mit folgender Adresse teilen (Bearbeiter-Zugriff), dann unten verbinden: {email}",
  "settings.driveFolderId": "Ordner-ID",
  "settings.driveFolderIdHint": "Aus der Ordner-URL: drive.google.com/drive/folders/[dieser Teil]",
  "settings.driveConnect": "Verbinden",
  "settings.driveConnecting": "Verbinde…",
  "settings.driveConnected": "Verbunden — Ordner „{name}“",
  "settings.driveDisconnect": "Trennen",
  ...
  "dash.energyFlow": "Energiefluss",
  "dash.energyFlowNote": "Wohin die Energie des Zeitraums ging, in kWh: was die Module erzeugt haben (einschliesslich dessen, was die Batterie geladen hat) und was aus dem Netz bezogen wurde, und was damit versorgt wurde — das Haus, die Teilnehmer oder das Netz. Die Batterie gibt weniger zurück, als sie aufgenommen hat: Umwandlungsverluste, plus was sie noch speichert. Zwei Darstellungen derselben Zahlen: die Bandbreiten des Sankey sagen wie viel, die radiale Karte sagt wohin, ihre Punkte laufen in Richtung der Energie.",
  "flow.grid": "Netz",
  "flow.gridImport": "Netz (Bezug)",
  "flow.sun": "Sonne",
  "flow.battery": "Batterie",
  "flow.house": "Haus",
  "flow.gridExport": "Netz (Einspeisung)",
  "flow.vzev": "vZEV-Teilnehmer",
  "flow.share": "{node}: {pct} %",
  "flow.noData": "Keine Messwerte in diesem Zeitraum.",
  "flow.table": "Energieflüsse im Zeitraum",
  "flow.view.radial": "Radial",
  "flow.view.sankey": "Sankey",
  "flow.liveTitle": "Jetzt, und heute bisher",
  "flow.liveNote": "Verbindungen: die Leistung, die in diesem Moment fliesst, live aus Home Assistant — die Punkte laufen in Richtung der Energie. Ringe: die Energie seit heute Morgen, aus den Messwerten, die dem Wechselrichter eine Synchronisation hinterherhinken; der Batteriering zeigt auch ihren Füllstand.",
  "flow.ofHouse": "{pct} % dessen, was das Haus bezieht ({load})",
