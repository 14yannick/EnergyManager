...
export const de: Record<keyof typeof en, string> = {
  ...
  "party.kpi.localShareSub": "{kwh} kWh aus der Solaranlage des RCP",
  "party.kpi.cost": "Kosten im RCP",
  "party.kpi.costSub": "Ø {rate} {cents}/kWh, alles inbegriffen",
  "party.kpi.saved": "Ersparnis gegenüber direkter Belieferung",
